...
$.trapKeyboard=function trapKeyboard(el,options){options=$.extend({deactivateOnFocusExit:false},options);var $focusable;$.untrapKeyboard();$trap=$(el);$focusable=$trap.focusable();$firstTabElement=$focusable.first();$lastTabElement=$focusable.last();if(options.deactivateOnFocusExit===true){$trap.focusExit().one('focusExit',function(e){$.untrapKeyboard();});}
